...
public class Program {
	...
	public static void hardCoding(Control c) {
		...
		LocalTime t5 = LocalTime.of(LocalTime.now().getHour(), LocalTime.now().getMinute());

		Flight f0 = new Flight("country1", "city1", "airport1", "airline1", d1, t1, "flightNumber0", 1, true);
		Flight f1 = new Flight("country2", "city2", "airport2", "airline2", d2, t2, "flightNumber1", 2, true);
		Flight f2 = new Flight("country3", "city3", "airport3", "airline3", d3, t3, "flightNumber2", 3, true);
		Flight f3 = new Flight("country4", "city4", "airport4", "airline4", d4, t4, "flightNumber3", 4, true);
		Flight f4 = new Flight("country5", "city5", "airport5", "airline5", d5, t5, "flightNumber4", 5, true);
		Flight f5 = new Flight("country1", "city1", "airport1", "airline1", d1, t1, "flightNumber5", 1, false);
		Flight f6 = new Flight("country2", "city2", "airport2", "airline2", d2, t2, "flightNumber6", 2, false);
		Flight f7 = new Flight("country3", "city3", "airport3", "airline3", d3, t3, "flightNumber7", 3, false);
		Flight f8 = new Flight("country4", "city4", "airport4", "airline4", d4, t4, "flightNumber8", 4, false);
		Flight f9 = new Flight("country5", "city5", "airport5", "airline5", d5, t5, "flightNumber9", 5, false);
	...
	private static Flight setFlight(Scanner scan, boolean incoming) {
		if (incoming)
			System.out.println(
	...
	private static String printFlights(ArrayList<Flight> flights) {
	...
	private static void searchFlights(Scanner scan, Control control) {
		boolean exit2 = false;
		...
		while (!exit2) {
			...
			case 7:
				...
				while (!exit4) {
					...
					System.out.println("1 - Sunday: " + days[6]);
					System.out.println("2 - Monday: " + days[0]);
					System.out.println("3 - Tuesday: " + days[1]);
					System.out.println("4 - Wednesday: " + days[2]);
					System.out.println("5 - Thursday: " + days[3]);
					System.out.println("6 - Friday: " + days[4]);
					System.out.println("7 - Saturday: " + days[5]);
			...
			case 8:
				System.out.println(printFlights(
						(control.search(incoming, airline, country, city, airport, days, startDate, endDate))));
				break;
			case 9:
				incoming = false;
				airline = null;
